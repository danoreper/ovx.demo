## Runs JAGS models on data frames. 
##
library("MASS")
library("rjags") 
library("coda")
...
##The main function that is the point of this R file.
##
## Given a data frame, a file with a jags model, the set of variables to
## record from the gibbs sampling, and a set of gibbs sampling parameters,
## this function converts the data frame into a form that is amenable to
## JAGS, applies JAGS, and converts its output back to a data frame that is easier to handle than the JAGS raw output.  
